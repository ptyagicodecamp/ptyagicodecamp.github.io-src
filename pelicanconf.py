...
THEME = str(BASE_DIR / 'themes' / 'Flex')
...
CATEGORY_FEED_ATOM = 'feeds/{slug}.atom.xml' #'feeds/{slug}.atom.xml'
...
IGNORE_FILES = [
    '**/.*',
    '**/NavDrawerDynamicMenu.md',
    '**/android-arch-lifecycle-viewmodel.md',
    '**/android-mvp-design-pattern.md',
    '**/android_flavors.md',
    '**/android_fonts.md',
    '**/androidapp_launcher_screen.m',
    '**/androidapp_launcher_screen.md',
    '**/fileprovider-demo.md',
    '**/repeating-local-notifications.md',
    '**/request_runtimepermission_audio.md',
]
