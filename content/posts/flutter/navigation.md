...
In dynamic navigation, routes are generated by implementing `onGenerateRoute` callback in the `MaterialApp` class. This is a type of Named Routing that make use of `onGenerateRoute` property.
