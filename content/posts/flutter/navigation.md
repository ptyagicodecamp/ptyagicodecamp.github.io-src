...
**Recipe:** Implement Navigation from home page to another page using three different ways.
...
* **Navigation:** Implement navigation from PageListing (homepage) to PageDetails (details page).

  - Sending data from PageListing to PageDetails page.
  - Receiving data from PageDetails page.
...
## Dynamic Named Routing Using `onGenerateRoute` Property
